...
const products = [
  ...
  {
    title: "Red Lipstick",
    description: "The Red Lipstick is a classic and bold choice for adding a pop of color.",
    category: "beauty",
    price: 12.99,
    priceInRupees: 1078,
  ...
  },
  {
    ...
    description: "The Red Nail Polish offers a rich and glossy red hue for vibrant nails.",
    category: "beauty",
    price: 8.99,
    priceInRupees: 746,
  ...
  },
  {
    ...
    description: "Elegant bathroom vanity with marble top and ceramic sink.",
    category: "furniture",
    price: 599.99,
    priceInRupees: 49799,
    discountPercentage: 7,
  ...
  {
    title: "Beef Steak",
    description: "Premium beef steaks, aged for tenderness.",
    category: "groceries",
    price: 12.99,
    priceInRupees: 1078,
    discountPercentage: 5,
...
async function migrateToAtlas() {
  try {
    ...
    console.log(`✅ ${result.length} products migrated to Atlas successfully!`);
